...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_calcPerceptron_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_CRTL_BUS_AWADDR, 
  ...
  x_Din_A, x_Dout_A, w_Clk_A, w_Rst_A, w_EN_A, w_WEN_A, w_Addr_A, w_Din_A, w_Dout_A, w_Clk_B, w_Rst_B, 
  w_EN_B, w_WEN_B, w_Addr_B, w_Din_B, w_Dout_B, b_Clk_A, b_Rst_A, b_EN_A, b_WEN_A, b_Addr_A, b_Din_A, 
  b_Dout_A, res_Clk_A, res_Rst_A, res_EN_A, res_WEN_A, res_Addr_A, res_Din_A, res_Dout_A, 
  res_Clk_B, res_Rst_B, res_EN_B, res_WEN_B, res_Addr_B, res_Din_B, res_Dout_B)
