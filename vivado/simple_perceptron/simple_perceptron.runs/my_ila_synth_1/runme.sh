...
HD_PWD='/home/wask/workspace/mgr/hls_perceptron/vivado/simple_perceptron/simple_perceptron.runs/my_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_ila.tcl
