...
cam = WebcamVideoStream.WebcamVideoStream(src=0).start()
# img_width = 320
# img_height = 240
# cam.set(3, img_width)
            ...
            for i,cnt in enumerate(contours):
                ...
                if(found_digits <= max_digits and h > 20 and h<200 and w > 10 and w < 200 and min_dim_ratio <= (w/float(h)) <= max_dim_ratio and hierarchy[0][i][3] == -1):
                    ...
                    with open("out.txt", 'r') as f:
                        ...
                        if not recognized_digit:
                            print("out.txt file empty")
                    # print("Recognized digit:", recognized_digit)
                    f.close()

                    cv2.putText(img, recognized_digit, (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,255,0), 1)
