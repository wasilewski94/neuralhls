...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("res_Addr_A", 32, hls_out, 1, "bram", "MemPortADDR2", 1),
	Port_Property("res_EN_A", 1, hls_out, 1, "bram", "MemPortCE2", 1),
	Port_Property("res_WEN_A", 2, hls_out, 1, "bram", "MemPortWE2", 1),
	Port_Property("res_Din_A", 16, hls_out, 1, "bram", "MemPortDIN2", 1),
	Port_Property("res_Dout_A", 16, hls_in, 1, "bram", "MemPortDOUT2", 1),
	Port_Property("res_Clk_A", 1, hls_out, 1, "bram", "mem_clk", 1),
	Port_Property("res_Rst_A", 1, hls_out, 1, "bram", "mem_rst", 1),
