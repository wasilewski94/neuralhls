...
// ==============================================================
#ifndef __calcPerceptron_fceOg__HH__
#define __calcPerceptron_fceOg__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calcPerceptron_fceOg) {
    ...
    SC_CTOR(calcPerceptron_fceOg):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
