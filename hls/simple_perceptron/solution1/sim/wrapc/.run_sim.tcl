...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "calcPerceptron.autotvin.dat"
	set constFileTvOut       "calcPerceptron.autotvout.dat"
	set constFileHdlTvIn     "calcPerceptron.autohdltvin.dat"
	set constFileHdlTvOut    "calcPerceptron.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
