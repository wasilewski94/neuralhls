...
if {[file isfile calcPerceptron.autotvin.dat]} {
	file delete -force calcPerceptron.autotvin.dat
}

if {[file isfile calcPerceptron.autotvout.dat]} {
	file delete -force calcPerceptron.autotvout.dat
}
