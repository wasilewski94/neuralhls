...
set Library     "hls"
set IPName      "calcPerceptron"
set Version     "1.0"
set DisplayName "Calcperceptron"
set Revision    "2006221934"
...
set sdx_kernel_name "calcPerceptron"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/wask/workspace/mgr/hls_perceptron/hls/simple_perceptron/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {calcPerceptron_fadd_32ns_32ns_32_5_full_dsp_1
...
## Variables
set Top "calcPerceptron"
set TopNoPrefix "calcPerceptron"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 inputs W 0x0 "Data signal of inputs" {{0 32 inputs W 0 "Bit 31 to 0 Data signal of inputs"}}} {0x18 neurons W 0x0 "Data signal of neurons" {{0 32 neurons W 0 "Bit 31 to 0 Data signal of neurons"}}} {0x20 w_offset W 0x0 "Data signal of w_offset" {{0 32 w_offset W 0 "Bit 31 to 0 Data signal of w_offset"}}} {0x28 b_offset W 0x0 "Data signal of b_offset" {{0 32 b_offset W 0 "Bit 31 to 0 Data signal of b_offset"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
