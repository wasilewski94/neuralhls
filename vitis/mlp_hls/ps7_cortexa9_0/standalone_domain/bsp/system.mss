...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = neural_net_axi_bram_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = neural_net_axi_bram_ctrl_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = neural_net_axi_bram_ctrl_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = neural_net_axi_bram_ctrl_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = calcPerceptron
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = neural_net_calcPerceptron_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = neural_net_axi_bram_ctrl_4
END
